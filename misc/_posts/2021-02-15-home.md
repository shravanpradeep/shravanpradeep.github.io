---
layout: default
title: <span style="font-size:90%;">Earth-Mediated Emergent Complex Matter<br><span style="font-size:60%;"><b>Materials Geomimicry | Functional Suspensions | Biofluid Dynamics
categories:
 - home
homepage: true
---

<p style="color: red;">I will be joining the Okinawa Institute of Science and Technology (OIST) Graduate University as a Tenure-Track Assistant Professor starting September 2026. The unit is actively recruiting for multiple Postdoctoral Scholar and Staff Scientist positions in the broader areas of soft particulate composites, hydration mechanics, and microbe-soil interactions. If you have experimental expertise (one or multiple areas) in rheology, tribology, confocal microscopy, porous media flows, or the soil microbiome, please reach out to <a href="mailto:shravan.pradeep@oist.jp">shravan.pradeep@oist.edu</a> with your CV and a brief research statement.</p>
...
<ul>
    ...
    <li>How can principles of adaptation inform design rules for engineering soils with tailored microstructure and composition?</li>
